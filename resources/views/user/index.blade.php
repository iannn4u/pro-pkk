    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">IYA</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            @endauth
                            @guest
                                <a class="nav-link dropdown-toggle" href="/signin">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    @auth
                        <span class="h3 mb-4 text-gray-800">My Saldo : <b>Rp @php echo number_format(Auth::user()->saldo, 0, ',', '.'); @endphp</b></span>
                        <a class="btn btn-info btn-icon-split mb-2 ml-1" data-toggle="modal" data-target="#topup">
                            <span class="text">Top Up</span>
                        </a>
                    @endauth
                    @guest
                        <span class="h3 mb-4 text-gray-800">My Saldo : <b>Rp @php echo number_format(0, 0, ',', '.'); @endphp</b></span>
                        <a href="/signin" class="btn btn-info btn-icon-split mb-2 ml-1">
                            <span class="text">Top Up</span>
                        </a>
                    @endguest
                </div>
                ...
                <form action="topup" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="number" name="saldo" class="form-control" id="exampleFormControlInput1"
